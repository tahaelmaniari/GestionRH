...
<div class="form-group text-right ml-5">
  <a href="{{route('employes.index')}}" style="width:40px;height:30px;" class="bnt btn-dark px-2 py-2">
  Revenir
    ...
    <div class="card card-default">
      <div class="card-header">
        <h3 class="card-title">Ajouter un utiliateur</h3>
            ...
            <form action="{{route('users.store')}}"method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <input type="password" class="form-control @if($errors->has('password_confirmation')) is-invalid @endif " name="password_confirmation" value="{{old('passwoed_confirmation')}}"/>
                  ...
                  <button class="btn btn-primary ml-4 mt-3">S'enregistrer</button>
              </form>
